...
public class AccountServiceTest
{
    ...
    [Fact]
    public async Task InsertAccountsAsync_Should_Be_Success()
    {
        var repository = new Mock<IAccountRepository>();
        var accountService = new AccountService(null!, repository.Object, null!);

        await accountService.InsertAccountsAsync(It.IsAny<IEnumerable<RefAccountCsv>>());

        repository.Verify(x => x.AddAccountsAsync(It.IsAny<IEnumerable<RefAccountCsv>>()), Times.Once);
    }
}
