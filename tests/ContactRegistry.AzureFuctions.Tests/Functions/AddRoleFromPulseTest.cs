// <copyright file="AddRoleFromPulseTest.cs" company="Pulse">
...
namespace ContactRegistry.AzureFuctions.Tests.Functions
{
    ...
    /// </summary>
    public class AddRoleFromPulseTest
    {
        /// <summary>
        ...
        {
            // Arrange
            var loggerMock = new Mock<ILogger<AddRoleFromPulse>>();
            ...
            var addAccountEvent = new RoleCreatedEvent(eventData);
            ...
            var function = new AddRoleFromPulse(loggerMock.Object, dbContextFactory.Object);
