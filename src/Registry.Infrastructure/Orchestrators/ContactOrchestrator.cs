    ...
    IOperationService operationService) : IContactOrchestrator
{
    ...
    {
        var contactEntity = refContext.ContactEntity.FirstOrDefault(x => x.Email == contact.Email);
    ...
    private ServiceBusMessage CreateUpdateMessage(RegOperationEntity operation, RefContactEntity contact)
    {
        ...
        var contactEntity = refContext.ContactEntity.FirstOrDefault(x => x.Email == emailToSearch);
